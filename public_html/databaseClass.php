...
// Rest is public by default
	...
	function connect()
  	{
	    if (($this->db_con = sqlsrv_connect("rsbdb-dev.uds.anu.edu.au", array("UID" => "eWorkbookAdmin", "PWD" => "eWork78623", "Database" => "eworkbooks"))) === false)
		{
		  print_r(sqlsrv_errors());
		  die("<br><br>Database is not available (password)");
		}
